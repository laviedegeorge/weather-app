...
var displayInfo = function displayInfo(obj) {
  document.getElementById("deg").innerHTML = "".concat(Math.round(obj.main.temp), "<sup class=\"deg\">0</sup>");
  document.getElementById("location").innerHTML = obj.name;
  var weatherIcon = document.createElement('img');
  weatherIcon.setAttribute('src', "http://openweathermap.org/img/wn/".concat(obj.weather[0].icon, ".png")), weatherIcon.setAttribute('height', '35px');
...
var getLocationByCords = function getLocationByCords(position) {
  ...
  var long = position.coords.longitude.toFixed(2); //console.log(lat,long)
...
var mainWeather = document.getElementById('main_weather');
mainWeather.addEventListener('click', function (e) {
  if (e.target === mainWeather) {
    mainD.classList.remove('side-nav');
  }
});
},{"./styles/style.css":"styles/style.css","./js/getWeather":"js/getWeather.js","./js/displayInfo":"js/displayInfo.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
